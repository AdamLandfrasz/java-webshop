...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Red Dead Redemption 2", 59.99f, "EUR", "The end of the wild west era has began as lawmen hunt down the last remaining outlaw gangs.", ps4, rockstar));
        productDataStore.add(new Product("Red Dead Redemption 2", 59.99f, "EUR", "The end of the wild west era has began as lawmen hunt down the last remaining outlaw gangs.", xBoxOne, rockstar));
        productDataStore.add(new Product("Red Dead Redemption 2", 59.99f, "EUR", "The end of the wild west era has began as lawmen hunt down the last remaining outlaw gangs.", pc, rockstar));
